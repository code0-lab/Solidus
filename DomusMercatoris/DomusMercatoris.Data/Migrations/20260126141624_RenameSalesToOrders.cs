...
{
    /// <inheritdoc />
    public partial class RenameSalesToOrders : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_CargoTrackings_CargoTrackingId",
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_FleetingUser_FleetingUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_VariantProducts_VariantProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_VariantProductId",
                table: "OrderItems",
                column: "VariantProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_CargoTrackingId",
                table: "Orders",
